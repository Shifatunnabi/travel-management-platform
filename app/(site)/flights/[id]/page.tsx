...
// Awaiting `params` suspends, so under Cache Components the detail body needs
// its own boundary — otherwise the whole route blocks and client navigations
// between two flights feel unresponsive.
